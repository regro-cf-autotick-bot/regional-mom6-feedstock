...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/regional-mom6-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/regional-mom6-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add regional-mom6
# for installing globally
pixi global install regional-mom6
```
...
It is possible to list all of the versions of `regional-mom6` available on your platform:
...
```
pixi search regional-mom6 --channel conda-forge
```
